...
class ViewController: UIViewController {
    ...
    @IBAction func presentPickerForImagesAndVideos(_ sender: Any) {
        presentPicker(filter: PHPickerFilter.videos)
    }
...
private extension ViewController {
    ...
    func displayNext() {
        ...
        if itemProvider.canLoadObject(ofClass: PHLivePhoto.self) {
            ...
            progress = itemProvider.loadFileRepresentation(forTypeIdentifier: UTType.movie.identifier) { [weak self]
                url, error in
                print("VVVV2222   ")
            ...
            print("VVVV11111  ", progress?.estimatedTimeRemaining)
        } else {
            progress = nil
        }
